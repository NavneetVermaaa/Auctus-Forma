...
const ContactForm: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 sm:py-20 md:py-24 lg:py-48 px-4 sm:px-6 bg-white dark:bg-black transition-colors duration-500">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 sm:gap-12 md:gap-16 lg:gap-20">

        {/* LEFT SIDE */}
        <div className="lg:w-1/2 space-y-8 sm:space-y-12">
          <div className="space-y-4 sm:space-y-6">
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-7xl tracking-tighter leading-none text-black dark:text-white">
              Let's Build Something <span className="italic">Intelligent</span>
            </h2>
            <p className="text-neutral-500 dark:text-neutral-400 text-sm sm:text-lg font-light max-w-sm tracking-tight leading-relaxed">
              We partner with a limited number of businesses per quarter to ensure artisanal quality and technical precision.
            </p>
          </div>

          <div className="space-y-3 sm:space-y-4 border-t border-neutral-100 dark:border-neutral-900 pt-6 sm:pt-8 md:pt-12">
            <p className="text-[10px] tracking-[0.3em] uppercase text-neutral-400 dark:text-neutral-600 font-bold">
              Availability
            </p>
            <p className="text-xs sm:text-sm font-medium uppercase tracking-[0.1em] text-emerald-600 dark:text-emerald-500">
        ...
        <div className="lg:w-1/2">
          <form onSubmit={handleSubmit} className="space-y-8 sm:space-y-12">
            ...
            <button
              ...
              className="w-full py-4 sm:py-6 bg-black text-white dark:bg-white dark:text-black text-[11px] uppercase tracking-[0.4em] font-medium hover:bg-neutral-900 dark:hover:bg-neutral-100 transition-colors disabled:opacity-50"
            >
            ...
            <div className="text-center">
              <p className="text-neutral-500 dark:text-neutral-400 text-xs sm:text-sm mb-3 sm:mb-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-green-600 hover:bg-green-700 text-white text-[10px] sm:text-[11px] uppercase tracking-[0.4em] font-medium transition-colors"
              >
