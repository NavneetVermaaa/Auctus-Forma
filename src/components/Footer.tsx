...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-black dark:bg-black text-white py-12 sm:py-16 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
            <a 
              ...
              className="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-xs uppercase tracking-[0.2em] font-medium transition-colors rounded-sm text-center"
            >
              WhatsApp
            </a>
            <a 
              href="mailto:navneet.v0000001@gmail.com" 
              className="px-4 py-2 border border-neutral-700 hover:border-neutral-500 text-white text-xs uppercase tracking-[0.2em] font-medium transition-colors rounded-sm text-center"
            >
              Email
            </a>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-neutral-800 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
          <p className="text-xs text-neutral-500 uppercase tracking-[0.2em] text-center sm:text-left">
